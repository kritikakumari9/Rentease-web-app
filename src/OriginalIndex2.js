...
TotalPeopleRated:TotalPeopleRated+1
  ...
  .catch((err)=>{
    ...
    ratingElem.append(star1,star2,star3,star4,star5,RatingBtn)
...
const starOuterElem=document.createElement('div')
starOuterElem.classList.add('starOuter')
const starInnerElem=document.createElement('div')
starInnerElem.classList.add('starInner')
...
starOuterElem.appendChild(starInnerElem)
Box.append(PeopleRatedElem,starOuterElem,starInnerElem,numberRatingElem,Breakline6)
